...
def validate_completion(completion):
    """
    Given as input a model generation it returns whether it is a valid or an invalid one.
    """
    ...
    if completion.startswith(
            ("as an ai", "as an artificial", "i am an ai", "i'm an ai", "i'm just an ai", "as a neutral",
             ...
             "as a neutral assistant", "as a neutral and informed assistant",  # Added for llama-3.2-1b responses.
             )):
        return "invalid"
